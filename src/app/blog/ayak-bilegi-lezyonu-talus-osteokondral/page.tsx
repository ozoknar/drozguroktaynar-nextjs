        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <ol className="space-y-3 text-sm text-gray-700">
              <li>
                1. Zengerink M, van Dijk CN. "Osteochondral lesions of the talus." Knee Surg Sports Traumatol Arthrosc. 2010. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=osteochondral+lesion+talus" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                2. Hannon CP, et al. "Osteochondral lesions of the talus: aspects of current management." Bone Joint J. 2014. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=talus+osteochondral+treatment" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                3. Verhagen RA, et al. "Systematic review of treatment strategies for osteochondral defects of the talar dome." Foot Ankle Clin. 2003. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=talar+dome+osteochondral+defect" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                4. Giannini S, et al. "Autologous chondrocyte implantation in osteochondral lesions of the talus." J Bone Joint Surg Am. 2001. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=chondrocyte+implantation+talus" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                5. Savage-Elliott I, et al. "Osteochondral lesions of the talus: a current concepts review and evidence-based treatment paradigm." Foot Ankle Spec. 2014. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=osteochondral+lesion+talus+current+concepts" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
              </li>
            </ol>
            ...
            <details className="mt-6">
              ...
              <ol start={6} className="space-y-3 text-sm text-gray-700 mt-4">
                <li>
                  6. Ferkel RD, et al. "Arthroscopic treatment of chronic osteochondral lesions of the talus." Am J Sports Med. 2008. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=arthroscopic+treatment+talus+osteochondral" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  7. Becher C, Thermann H. "Results of microfracture in the treatment of articular cartilage defects of the talus." Foot Ankle Int. 2005. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=microfracture+talus+cartilage" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  8. Lopes R, et al. "Bone marrow aspirate concentrate for the treatment of osteochondral lesions of the talus." Foot Ankle Surg. 2016. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=bone+marrow+aspirate+talus" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  9. Murawski CD, Kennedy JG. "Operative treatment of osteochondral lesions of the talus." J Bone Joint Surg Am. 2013. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=operative+treatment+osteochondral+talus" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  10. Kumai T, et al. "Osteochondral defects of the talus in ankle fracture." Foot Ankle Int. 2010. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=osteochondral+defect+talus+ankle+fracture" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">&#91;PubMed Ara&#93;</a>
                </li>
              </ol>
            </details>
          </div>
