    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gradient-to-r from-[#01CAB8] to-purple-600 rounded-2xl p-8 text-white mb-8">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <ol className="space-y-3 text-sm text-gray-700">
              <li>
                1. Strickland JW. "Development of flexor tendon surgery: twenty-five years of progress." J Hand Surg Am. 2000. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=flexor+tendon+surgery" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                2. Tang JB. "Clinical outcomes associated with flexor tendon repair." Hand Clin. 2005. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=flexor+tendon+repair+outcomes" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                3. Dy CJ, et al. "Flexor tendon repair: a simplified model for evaluation of grip and pinch strength." J Hand Surg Am. 2012. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=flexor+tendon+grip+strength" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                4. Walbeehm ET, et al. "Flexor tendon injuries of the hand in adults." Hand Surg. 2003. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=flexor+tendon+injuries+hand" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                5. Pettengill KM. "The evolution of early mobilization of the repaired flexor tendon." J Hand Ther. 2005. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=early+mobilization+flexor+tendon" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
            </ol>
            ...
            <details className="mt-6">
              ...
              <ol start={6} className="space-y-3 text-sm text-gray-700 mt-4">
                <li>
                  6. Savage R, Risitano G. "Flexor tendon repair using a six-strand method of repair and early active mobilization." J Hand Surg Br. 1989. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=six-strand+flexor+tendon+repair" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  7. Amadio PC. "Friction of the gliding surface: implications for tendon surgery and rehabilitation." J Hand Ther. 2005. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=tendon+gliding+friction" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  8. Zhao C, et al. "The A2 pulley system: a biomechanical study." J Hand Surg Am. 2006. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=A2+pulley+biomechanics" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  9. Kleinert HE, Verdan C. "Report of the Committee on Tendon Injuries." J Hand Surg Am. 1983. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=tendon+injuries+classification" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  10. Elliot D, et al. "The rupture rate of acute flexor tendon repairs mobilized by the controlled active motion regimen." J Hand Surg Br. 1994. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=flexor+tendon+controlled+active+motion" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
              </ol>
            </details>
          </div>
