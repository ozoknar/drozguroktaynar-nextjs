          ...
          <section className="mt-12 bg-gray-50 p-6 rounded-xl">
            ...
            <ol className="space-y-3 text-sm text-gray-700">
              <li>
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/19540777/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 19540777</a>
              </li>
              <li>
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/23510748/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 23510748</a>
              </li>
              <li>
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/23040548/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 23040548</a>
              </li>
              <li>
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/18835532/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 18835532</a>
              </li>
              <li>
                ...
                <a href="https://pubmed.ncbi.nlm.nih.gov/20621893/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 20621893</a>
              </li>
            </ol>
            ...
            <details className="mt-4">
              ...
              <ol start={6} className="space-y-3 text-sm text-gray-700 mt-4 pt-4 border-t">
                <li>
                  ...
                  <a href="https://pubmed.ncbi.nlm.nih.gov/22298054/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 22298054</a>
                </li>
                <li>
                  ...
                  <a href="https://pubmed.ncbi.nlm.nih.gov/20709944/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 20709944</a>
                </li>
                <li>
                  <span className="font-medium">8.</span> Kulund DN, et al. <em>"The injured athlete."</em> JB Lippincott, 1988.{' '}
                  <a href="https://pubmed.ncbi.nlm.nih.gov/3392378/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 3392378</a>
                </li>
                <li>
                  ...
                  <a href="https://pubmed.ncbi.nlm.nih.gov/2797758/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 2797758</a>
                </li>
                <li>
                  ...
                  <a href="https://pubmed.ncbi.nlm.nih.gov/5054450/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PMID: 5054450</a>
                </li>
              </ol>
            </details>
          </section>
