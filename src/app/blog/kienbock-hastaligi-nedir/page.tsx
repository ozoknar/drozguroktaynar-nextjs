    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gradient-to-r from-[#01CAB8] to-indigo-600 rounded-2xl p-8 text-white mb-8">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <ol className="space-y-3 text-sm text-gray-700">
              <li>
                1. Lutsky K, et al. "Kienböck disease: an update on diagnosis and treatment." J Hand Surg Am. 2012. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+diagnosis+treatment" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                2. Moran SL, et al. "Kienböck's disease." J Am Acad Orthop Surg. 2008. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+review" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                3. Lichtman DM, et al. "A new classification of Kienböck's disease." J Hand Surg Am. 2010. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+classification" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                4. Chung KC, et al. "Outcomes of pyrocarbon arthroplasty for the treatment of advanced Kienböck's disease." J Hand Surg Am. 2009. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+arthroplasty" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
              <li>
                5. Delawerde WJ, et al. "Radial osteotomy for Kienböck disease." J Hand Surg Am. 2008. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+radial+osteotomy" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
              </li>
            </ol>
            ...
            <details className="mt-6">
              ...
              <ol start={6} className="space-y-3 text-sm text-gray-700 mt-4">
                <li>
                  6. Shin AY, Bishop AT. "Vascularized bone grafting for Kienböck's disease." Tech Hand Up Extrem Surg. 2002. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+vascularized+bone+graft" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  7. Innes L, Strauch RJ. "Systematic review of the treatment of Kienböck's disease in its early and late stages." J Hand Surg Am. 2010. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+systematic+review" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  8. Arnaiz J, et al. "MR imaging of Kienböck disease." AJR Am J Roentgenol. 1994. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+MRI" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  9. Beckenbaugh RD, et al. "Kienböck's disease: the natural history of Kienböck's disease and consideration of lunate fractures." Clin Orthop Relat Res. 1980. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+natural+history" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
                <li>
                  10. Gelberman RH, et al. "The vascularity of the lunate bone and Kienböck's disease." J Hand Surg Am. 1980. <a href="https://pubmed.ncbi.nlm.nih.gov/?term=kienbock+disease+vascularity+lunate" target="_blank" rel="noopener noreferrer" className="text-[#01CAB8] hover:text-[#01867A]">&#91;PubMed Ara&#93;</a>
                </li>
              </ol>
            </details>
          </div>
