        ...
        <section className="grid md:grid-cols-2 gap-8 items-center mb-16">
          ...
          <div className="relative">
            <div className="aspect-[4/3] bg-gray-200 rounded-2xl overflow-hidden">
              <img
                src="https://www.drozguroktaynar.com/wp-content/uploads/2023/04/5i6a7025-1024x683.jpg"
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
              <img
                src="https://www.drozguroktaynar.com/wp-content/uploads/2023/04/21-x-30-cm-folyo-baski-b.jpg"
                alt="Sertifika"
            ...
            <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
              <img
                src="https://www.drozguroktaynar.com/wp-content/uploads/2023/04/15-x-21-cm-folyo-baski.jpg"
                alt="Sertifika"
                className="w-full h-full object-cover hover:scale-105 transition"
              />
            </div>
            <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
              <img
                src="https://www.drozguroktaynar.com/wp-content/uploads/2023/04/23-x-33-cm-folyo-baski.jpg"
                alt="Sertifika"
                className="w-full h-full object-cover hover:scale-105 transition"
              />
            </div>
            <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
              <img
                src="https://www.drozguroktaynar.com/wp-content/uploads/2023/04/21-x-30-cm-folyo-baski-s.jpg"
                alt="Sertifika"
                className="w-full h-full object-cover hover:scale-105 transition"
              />
            </div>
